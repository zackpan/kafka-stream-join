...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9127509352486565471L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.abn.demo.stream.model\",\"fields\":[{\"name\":\"name\",\"type\":\"string\",\"avro.java.string\":\"String\"},{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public Product(java.lang.CharSequence name, java.lang.Integer id) {
    this.name = name;
    this.id = id;
  }
   ...
   */
  public static com.abn.demo.stream.model.Product.Builder newBuilder() {
    return new com.abn.demo.stream.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.abn.demo.stream.model.Product.Builder newBuilder(com.abn.demo.stream.model.Product.Builder other) {
    if (other == null) {
      return new com.abn.demo.stream.model.Product.Builder();
    } else {
      return new com.abn.demo.stream.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.abn.demo.stream.model.Product.Builder newBuilder(com.abn.demo.stream.model.Product other) {
    if (other == null) {
      return new com.abn.demo.stream.model.Product.Builder();
    } else {
      return new com.abn.demo.stream.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.abn.demo.stream.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.abn.demo.stream.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.abn.demo.stream.model.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.abn.demo.stream.model.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.abn.demo.stream.model.Product.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.abn.demo.stream.model.Product.Builder clearId() {
